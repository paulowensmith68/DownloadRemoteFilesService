...
Public Class DownloadRemoteFilesService
    ...
    Protected Overrides Sub OnStart(ByVal args() As String)
        ...
        gobjEvent.WriteToEventLog("Service Start Banner:    *     DownloadRemoteFilesService STARTING      *")
        gobjEvent.WriteToEventLog("Service Start Banner:    ************************************************")
    ...
    Private Sub InitializeComponent()
        ...
        '
        Me.ServiceName = "DownloadRemoteFilesService"
...
Public Class Worker
    ...
    Public Sub StopWork()
        ...
        gobjEvent.WriteToEventLog("Service Stopping Banner: *       DownloadRemoteFilesService STOPPED     *")
        gobjEvent.WriteToEventLog("Service Stopping Banner: ************************************************")
    ...
    Function StartProcess() As Boolean
        ...
        Try
            ...
            gobjEvent.WriteToEventLog("StartProcess:    *--- DownloadRemoteFilesService Process Start ----")
            gobjEvent.WriteToEventLog("StartProcess:    *--------------------------------------------------")
